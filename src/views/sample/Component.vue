<template>
  <div class="contents" style="padding:2rem">
    ...
    <button class="btn-type1 st1">버튼 type1 st1</button> <br />
    <button class="btn-type1 st2">버튼 type1 st2</button> <br />
    <button class="btn-type1 st2 inbl">버튼 type1 st2  inbl</button> <br />
    <button class="btn-type2 st1">버튼 type2 st1</button> <br />
    <button class="btn-type2 st2 inbl">버튼 type2 st2  inbl</button> <br />
    <button class="btn-type3 st1">버튼 type3 st1</button> <br />
    <button class="btn-type3 st2 inbl">버튼 type3 st2  inbl</button>
